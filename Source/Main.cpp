	...
	LPSTR lpCmdLine, int nCmdShow)
{
	...
	while (ProcessMessage() == 0 && CheckHitKey(KEY_INPUT_ESCAPE) == 0)
	{
		...
		//	// カメラの注視点の座標を取得
		//	VECTOR center = Master::mpCamera->GetLookAtPosition();

		//	// 真ん中に白い球
		//	DrawSphere3D(center, 50.0f, 16, GetColor(255, 255, 255), GetColor(0, 0, 0), TRUE);

		//	// 左端に赤い球
		//	VECTOR leftPos = VAdd(center, VGet(-400.0f, 0, 0));
		//	DrawSphere3D(leftPos, 50.0f, 16, GetColor(255, 0, 0), GetColor(0, 0, 0), TRUE);

		//	// 右端に青い球
		//	VECTOR rightPos = VAdd(center, VGet(400.0f, 0, 0));
		//	DrawSphere3D(rightPos, 50.0f, 16, GetColor(0, 0, 255), GetColor(0, 0, 0), TRUE);
		//	SetUseLighting(TRUE);
		//}
